...
namespace Melville.SystemInterface.USB
{
    internal static class NativeMethods
    {
        ...
        /// <summary>Purges NativeMethods transmit buffer by aborting the current transmission.</summary>
        public const uint PURGE_TXABORT = 0x01;
        /// <summary>Purges NativeMethods receive buffer by aborting the current receive.</summary>
        public const uint PURGE_RXABORT = 0x02;
        /// <summary>Purges NativeMethods transmit buffer by clearing it.</summary>
        public const uint PURGE_TXCLEAR = 0x04;
        /// <summary>Purges NativeMethods receive buffer by clearing it.</summary>
        ...
        public static SafeFileHandle InvalidHandleValue = new SafeFileHandle(new IntPtr(-1), true);
        #endregion
        ...
        public static extern IntPtr SetupDiGetClassDevs(ref Guid gClass, [MarshalAs(UnmanagedType.LPWStr)] string? strEnumerator, IntPtr hParent, uint nFlags);
        /// <summary>
        ...
        [DllImport("setupapi.dll", SetLastError = true)]
        public static extern bool SetupDiEnumDeviceInterfaces(IntPtr lpDeviceInfoSet, IntPtr nDeviceInfoData, ref Guid gClass, uint nIndex, ref DeviceInterfaceData oInterfaceData);
        /// <summary>
        ...
        public static extern SafeFileHandle CreateFile([MarshalAs(UnmanagedType.LPStr)] string strName, uint nAccess, uint nShareMode, IntPtr lpSecurity, uint nCreationFlags, uint nAttributes, IntPtr lpTemplate);
        /// <summary>
