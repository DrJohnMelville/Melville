...
/* Float precision */
        ...
        * ********** */
        ...
        public static int Solve(MpFunc funct, int m, int npar,
            double[] xall, MpPar[] pars, MpConfig config, object prv,
            ref MpResult result)
        {
        ...
        private static int mp_fdjac2(MpFunc funct,
            ...
            int[] ddebug, double[] ddrtol, double[] ddatol)
        {
            ...
            */
            ...
            if (hasDebugDeriv != 0)
            {
                Debug.WriteLine("FJAC DEBUG BEGIN");
            ...
            if (hasNumericalDeriv != 0)
            {
                ...
                {  /* Loop thru free parms */
                    ...
                    if (debug != 0)
                    {
                        Debug.WriteLine("FJAC PARM {0}", ifree[j]);
                    }
            ...
            if (hasDebugDeriv != 0)
            {
                Debug.WriteLine("FJAC DEBUG END");
            }
