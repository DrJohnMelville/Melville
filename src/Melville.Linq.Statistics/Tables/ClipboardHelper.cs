...
EndSelection:<<<<<<<<4";
    ...
    /// <summary>
    /// Clears clipboard and sets the given  HTML and to the clipboard, providing additional  meta-information for HTML.<br/>      
    /// Also sets the HTML to the plain text.
    ///     
    /// </summary>
    /// <param name="html"></param>
    public static void CopyToClipboard(string html) => CopyToClipboard(html, html);
